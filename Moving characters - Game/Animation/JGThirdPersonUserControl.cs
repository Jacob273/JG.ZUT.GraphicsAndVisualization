...
namespace JakubGmur.Animations
{
    ...
    {
        /// <summary>
        /// Character that we control
        /// </summary>
        private JGThirdPersonCharacter m_Character;

        /// <summary>
        /// Object that has PointsLoader component.
        /// </summary>
        public GameObject ownerOfPointsLoader;

        /// <summary>
        /// Limit anglee which has impact movement (if we strictly move or stop and rotate)
        /// </summary>
        ...
        /// <summary>
        /// List of the target point character should visit.
        /// </summary>
